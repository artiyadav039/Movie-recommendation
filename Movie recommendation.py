...
movies_df = pd.read_csv(r"C:\Users\Arti\Downloads\Project\tmdb_5000_movies.csv")
credits_df = pd.read_csv(r"C:\Users\Arti\Downloads\Project\tmdb_5000_credits.csv")
movies_df.head()
...
movies_df[['title','popularity']].sort_values(by = ['popularity'], ascending = False)
...
print("################ Content Based Filtering - (on Overview of movies)#############")
print()
...
df= movies_df[['title' , 'tagline']].groupby(by = ['tagline'], axis= 0)
df.first()
...
tfidf_matrix = tfidf.fit_transform(movies_df["tagline"])
print(tfidf_matrix.shape)
...
print("################ Content Based Filtering - (on taglines of movies)#############")
print()
print("Recommendations for The Dark Knight Rises")
print(get_recommendations("The Dark Knight Rises"))
print()
...
print("################ Content Based System - metadata (keywords, cast', 'director', 'genres')#############")
